...
public class NetworkMenu extends JFrame {
	...
	private JTextField jtf_port = new JTextField(""+Constant.DEFAULT_CONNECTION_PORT);
	...
	private NetworkMenu()
	{
		...
		jb_ok.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				Game.getInstance().connect(jtf_host.getText(),Integer.parseInt(jtf_port.getText()));
				afficher(false);
			}
		});
